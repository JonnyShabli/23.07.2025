...
func NewZipper(db repository.StorageInterface, logger logster.Logger) *Zipper {
	return &Zipper{
		db:     db,
...
func (z *Zipper) AddTask(ctx context.Context) (uuid.UUID, error) {
	return z.db.AddTask(ctx)
}

func (z *Zipper) AddLinks(ctx context.Context, links []string, id string) (int, error) {
...
func (z *Zipper) GetStatus(ctx context.Context, id string) (*models.Status, error) {
